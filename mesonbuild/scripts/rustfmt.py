...
from .rustfmt import get_nonwrap_subprojects
...
class Rustfmt:
    def __init__(self, rustfmt: T.List[str], args: T.List[str], subprojects: T.Set[str]):
...
def run(args: T.List[str]) -> int:
    ...
    return run_tool_on_targets(Rustfmt(rustfmt, ['--check'] if options.check else [], subproject_list))
