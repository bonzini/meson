...
class ConsoleLogger(TestLogger):
        ...
        async def report_progress():
            ...
            while not self.stop:
                ...
                if not self.progress_test:
                    ...
                    self.progress_test = self.running_tests.popitem(last=False)
    ...
    def start_test(self, test: 'TestRun'):
...
class TestHarness:
    ...
    def open_log_files(self) -> None:
        ...
        self.loggers.append(TextLogfileBuilder(self.logfilename, errors='surrogateescape'))
