...
class MesonMain(MesonInterpreterObject):
    ...
    def _process_script_args(
            self, name: str, args: T.Sequence[T.Union[
                str, mesonlib.File, build.FileTarget,
    ...
    @typed_pos_args(
        ...
        varargs=(str, mesonlib.File, build.FileTarget, build.CustomTargetIndex, ExternalProgram)
    )
    @typed_kwargs(
        'meson.add_install_script',
    ...
    def add_install_script_method(
            ...
            args: T.Tuple[T.Union[str, mesonlib.File, build.Executable, ExternalProgram],
                          T.List[T.Union[str, mesonlib.File, build.FileTarget, build.CustomTargetIndex, ExternalProgram]]],
